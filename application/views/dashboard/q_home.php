                                ...
                                <?php if($questions != null) : ?>
                                    ...
                                    <div class="card mb-5">
                                        <div class="card-header d-flex justify-content-between">
                                            ...
                                            <a href="<?=base_url('dashboard/qna?q='.$question['id']);?>">View Answers</a>
                                        </div>
                                        <div class="card-body">
                                            <p><?= $question['body']; ?></p>
                                        </div>
                                    ...
                                    <?php endforeach; ?>
                                <?php else : ?>
                                    <center class="py-4">No Questions Found</center>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Hack - o - Vation &copy; Prosolver 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
