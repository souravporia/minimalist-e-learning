...
<head>
    ...
    <title>Dashboard - Virtual Lab</title>
            ...
            <div id="content">
                ...
                <div class="px-lg-5">
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Experiments</h6>
                                </div>
                                <div class="card-body">
                                  <ul class="list-group">
                                      <?php foreach($experiments as $e) : ?>
                                    <li class="list-group-item"><a class="text-gray-800" href="<?= base_url('dashboard/lab?q='.$e['id']);?>"><?= $e['name'];?></a></li>
                                    <?php endforeach; ?>
                                  </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                        <?php foreach($experiments as $e) : ?>
                            <?php if($e['id'] == $experiment_id) : ?>
                            <!-- Collapsable Card Example -->
                            <div class="card shadow mb-4">
                                <!-- Card Header - Accordion -->
                                <a href="#collapseCardobj" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                    <h6 class="m-0 font-weight-bold text-primary">Objectives</h6>
                                </a>
                                <!-- Card Content - Collapse -->
                                <div class="collapse show" id="collapseCardobj">
                                    <div class="card-body">
                                      <?=$e['objective'];?>
                                    </div>
                                </div>
                            ...
                            <div class="card shadow mb-4">
                              <!-- Card Header - Accordion -->
                              <a href="#collapseCardalgo" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                  <h6 class="m-0 font-weight-bold text-primary">Algorithm and Demo</h6>
                              </a>
                              <!-- Card Content - Collapse -->
                              <div class="collapse show" id="collapseCardalgo">
                                  <div class="card-body">
                                  <?=$e['algorithm'];?>
                                  </div>
                                  <div class="card-footer"><a class="btn btn-primary" href="<?= base_url('simulation?q='.$e['id']);?>" role="button">Simulation</a></div>
                              </div>
                          </div>
                        <?php endif; ?>
                        <?php endforeach;?>
